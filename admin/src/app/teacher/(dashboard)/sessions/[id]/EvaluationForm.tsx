...
export function EvaluationForm({ sessionId, defaultContent }: { sessionId: number; defaultContent: string }) {
  ...
  return (
    <form action={formAction} className="flex max-w-2xl flex-col gap-3">
      <textarea
        ...
        rows={12}
        placeholder="오늘 수업에서 배운 표현, 발화 참여도, 교정이 필요한 부분, 다음 수업 목표 등을 자유롭게 적어주세요."
